...
class Patcher {
     ...
     * @param {Buffer} targetBuffer - The buffer to patch.
     * @param {Array<{find: Buffer, replace: Buffer, lineNumber: number}>} replacements - Array of replacement rules.
     * @returns {Buffer|null} The modified buffer if patching was attempted (even if no matches found), or null on a critical error (like unexpected size change).
     */
    applyToBuffer(targetBuffer, replacements) {
     ...
     * @param {Array<{find: Buffer, replace: Buffer, lineNumber: number}>} replacements - Array of replacement rules.
     * @returns {boolean} True if the patch was applied successfully or no changes were needed, false otherwise.
     */
    applyToFile(targetFilePath, replacements) {
